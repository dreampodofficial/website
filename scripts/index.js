...
const orderButtons = document.getElementsByClassName("dreampod-category-description-contact");
const dialogWindow = document.querySelector(".dreampod-category-dialog");
const dialogWindows = document.getElementsByClassName("dreampod-category-dialog");
...
const dialogWindowSubContainer = document.querySelector(".dreampod-category-dialog-subcontainer");
const dialogWindowSubContainers = document.getElementsByClassName("dreampod-category-dialog-subcontainer");
// dialogWindowSubContainer.style.animation = "900ms ease-in 1 normal slideUp";

const closeDialogButton = document.querySelector(".dreampod-category-dialog-close");
const closeDialogButtons = document.getElementsByClassName("dreampod-category-dialog-close");

// const navContact = document.querySelector("a.dreampod-category-description-contact");
// navContact.addEventListener('click', (el, ev) => {
//   console.log("called");
//   ev.preventDefault();
// });
